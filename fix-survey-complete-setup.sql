-- Complete Survey Setup and Fix
-- This script creates the missing enum and fixes all survey creation issues
...
-- 8. Add policies for surveys table
...
-- 11. Add policies for survey_questions table
