-- Simple Survey Fix - No Complex Team References
-- This script creates surveys without the problematic team_id references
...
-- 8. Add simple policies for surveys table (no team references)
CREATE POLICY "Users can view surveys" ON public.surveys
  FOR SELECT USING (true); -- Allow all users to view surveys
...
-- 11. Add simple policies for survey_questions table
CREATE POLICY "Users can view survey questions" ON public.survey_questions
  FOR SELECT USING (true); -- Allow all users to view questions
